...
- ✘ **Не работает с BibleQuote 7.x** — для этой ветки есть [отдельный репозиторий](https://github.com/<ваш_ник>/BibleQuote-VerseComparison-v7.5-Tools)
...
- ✘ **Does not work with BibleQuote 7.x** — see the [v7.5 repository](https://github.com/<your_handle>/BibleQuote-VerseComparison-v7.5-Tools)
